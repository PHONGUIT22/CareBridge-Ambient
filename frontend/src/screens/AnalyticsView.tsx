      ...
      <div className="max-w-2xl mx-auto flex flex-col gap-4">
        ...
        <div className="grid grid-cols-3 gap-2.5">
          ...
          >
            <FontAwesomeIcon
              icon={faHeartPulse}
              className={`text-xs ${activeTab === 'bloodPressure' ? 'text-rose-950' : 'text-rose-400'}`}
            />
          ...
          >
            <FontAwesomeIcon
              icon={faDroplet}
              className={`text-xs ${activeTab === 'bloodSugar' ? 'text-cyan-950' : 'text-[#00CAFF]'}`}
            />
          ...
          >
            <FontAwesomeIcon
              icon={faHeartPulse}
              className={`text-xs ${activeTab === 'heartRate' ? 'text-amber-950' : 'text-amber-400'}`}
            />
        ...
        <div className="alexa-card rounded-3xl p-5 relative overflow-hidden">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
            ...
            <div className="flex items-center gap-3 text-xs font-semibold">
              ...
              {activeTab === 'bloodSugar' && (
                <div className="flex items-center gap-1.5 text-slate-300">
                  <span className="w-2.5 h-2.5 rounded-full bg-[#00CAFF]" />
                  <span>mg/dL</span>
                </div>
              )}
              {activeTab === 'heartRate' && (
              ...
              <AreaChart data={vitalsData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                <defs>
                  ...
                  <linearGradient id="diastolicGradient" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="#00caff" stopOpacity={0.4} />
                    <stop offset="95%" stopColor="#00caff" stopOpacity={0.0} />
                  </linearGradient>
        ...
        <div
          className={`alexa-card rounded-3xl p-4.5 flex items-start gap-3.5 border ${
