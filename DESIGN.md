...
### 6.5 Technical Agent Console (`AlexaAgentConsole.tsx`)
- Designed for judges and developers in Dual Frame mode.
- Collapsible tool pills: Tool icon + name (`clinicalAdvisor`, `logDoseStatus`) + latency pill (e.g., `420ms`).
- Expandable accordion for inspection of raw JSON parameters and return payloads.
